...
// Title Strings that will be added as a quest in the menu
let questTitles = [
...
// Description paragraphs that will be added to each quest in the menu
let questDescs = [
...
// For each questListing HTML element, add an event to change the "Details" Panel when we click the element
questListings.forEach(function(element, index) {
    element.onclick = function(event) {
        ...
        // Change the "Details" panel to show descriptions
